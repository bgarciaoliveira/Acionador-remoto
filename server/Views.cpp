...
void WritePageHead(EthernetClient &client, String title, bool closeHead = true){
  ...
  client.print(F(
    ...
    "<link href='http://oneratus.com/AcionadorRemoto/css/bootstrap.min.css' rel='stylesheet'>"
    "<link href='http://oneratus.com/AcionadorRemoto/css/style.css' rel='stylesheet'>" 
    ));
...
void WriteFooter(EthernetClient &client){
  ...
  "<footer class='footer'>"
   "<div class='container'>"
   "<p class='text-muted'>&copy; <a href='http://oneratus.com' target='_blank'>Projeto Oneratus</a> - Todos os direitos reservados.</p>"
   "</div>"
   "</footer>"
   ));
}
...
void WriteScripts(EthernetClient &client){
    ...
    client.print(F(
     ...
     "<script src='http://oneratus.com/AcionadorRemoto/js/jquery.min.js'></script>"     
     "<script src='http://oneratus.com/AcionadorRemoto/js/bootstrap.min.js'></script>"
     "<script src='http://oneratus.com/AcionadorRemoto/js/notify.js'></script>"
     "<script src='http://oneratus.com/AcionadorRemoto/js/loading.js'></script>"
     "<script src='http://oneratus.com/AcionadorRemoto/js/scripts.js'></script>"
     ));  
}
...
void WriteMainPage(EthernetClient &client){
  ...
  client.print(F(
    ...
    client.print("<a href='/?[" + String(CODE_IRIS) + "]'><button type='button' class='btn btn-success btn-door'>Iris</button></a>");
...
void WriteSettings(EthernetClient &client){
    ...
    client.print(F("<meta http-equiv='refresh' content='120; url=/?[8]'>"));
    client.print(F("</head>"));
